...
//   if (loading) {
//     return (
//       <View className="mt-2 p-2 rounded-lg items-center justify-center">
//         <ActivityIndicator size="small" color={theme.accentHover} />
//       </View>
//     );
//   }
//   return (
...
//   // if (loading) {
//   //   return (
//   //     <View className="mt-2 p-2 rounded-lg bg-accent items-center justify-center">
//   //       <ActivityIndicator size="small" color={theme.accentHover} />
//   //     </View>
//   //   );
//   // }
