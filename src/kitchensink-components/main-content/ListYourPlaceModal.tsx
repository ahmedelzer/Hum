      ...
      <Modal
        ...
        <ModalContent className="p-4">
          <ModalHeader>
            ...
            <ModalCloseButton>
              <Icon as={CloseIcon} className="w-4 h-4" color={"#404040"} />
            </ModalCloseButton>
          </ModalHeader>
...
const SaveForLaterButton = ({ setModalVisible, toast }: any) => {
  ...
  return (
    <Box className="w-full">
      {showSpinner ? (
        <Center>
          <Spinner size="large" color={"#333333"} />
        </Center>
      ) : (
        <Button
          action="secondary"
            ...
            <RadioGroup
              ...
              <HStack space="md">
                <Radio value="Residential">
                  <RadioIndicator>
                    <RadioIcon as={CircleIcon} color={"#292929"} />
                  </RadioIndicator>
          ...
          {sidebarFiltersAmmenities.map((ammenity: any) => {
            return (
              <Checkbox
                ...
                <CheckboxIndicator>
                  <CheckboxIcon as={CheckIcon} color={"#171717"} />
                </CheckboxIndicator>
