...
const CartPage = () => {
  ...
  return (
    <View className="flex-1 bg-body">
      {/* Header */}
      <View className="flex-row items-center justify-start p-4 border-b border-card">
        ...
        <View>
          ...
          <Text className="text-sm text-text">KFC</Text>
        </View>
      </View>
      ...
      <View className="flex-row items-center justify-between bg-body p-4 border-t border-card">
        <TouchableOpacity
        ...
        <TouchableOpacity className="flex-1 bg-accent py-3 rounded-lg">
          <Text className="text-center text-body">Checkout</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
