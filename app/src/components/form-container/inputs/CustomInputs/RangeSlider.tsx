...
// todo to solve that error run the app with npx react-native run-android
const RangeSlider = ({ sliderWidth, min, max, step, onValueChange }) => {
  ...
  console.log("s");
  console.log("====================================");
  // Helper function to call onValueChange safely
  ...
  const pan = Gesture.Pan()
    ...
    .onEnd(() => {
      opacity.value = 0;
      handleValueChange(); // Call the handler to update value
    });
